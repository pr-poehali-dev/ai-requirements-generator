    ...
    <div style={s.card}>
      <div style={s.statsGrid}>
        ...
        <div style={s.statBoxGreen}>
          ...
          <span style={s.statLabel}>Реалистичная<br />оптимизация</span>
        </div>
      </div>
    </div>
    <div style={s.economyBox}>
...
const agents: { id: AgentId; label: string; subtitle: string }[] = [
  ...
  { id: "underwriter", label: "Цифровой двойник Андеррайтеров Имущества", subtitle: "Анализ экономического эффекта от внедрения ИИ-агента для андеррайтинга по имуществу. Реалистичная оптимизация 45%. Период: 1 год." },
];
