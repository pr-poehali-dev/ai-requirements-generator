...
const agents: { id: AgentId; label: string; subtitle: string }[] = [
  { id: "ba", label: "Универсальный ассистент бизнес/системных-процессов", subtitle: "Анализ эффективности внедрения ИИ-ассистента для бизнес-аналитиков. Период: 1 год." },
