...
const agents: { id: AgentId; label: string; subtitle: string }[] = [
  ...
  { id: "twin", label: "Конструктор Цифрового двойника сотрудника", subtitle: "Анализ эффективности внедрения ИИ-агента для Совкомбанка с периодом в 1 год. Оптимизация рутинных задач в Pyrus — без кода, без IT-затрат, с оптимизацией рабочих процессов до 5% времени." },
];
