...
const hrTableData = [
  ...
  { id: 2,  name: "Анализ резюме (рекрутеры)",                             wDay:"87",      wMon:"1 740,00",  wYear:"21 391,75",   aiDay:"26,1",   aiMon:"522",      aiYear:"6 417,53",  saveH:"14 974,23",  saveR:"11 230 669" },
            ...
            {modal === "methodology" && (
              <>
                ...
                {[
                  "1. Норматив: 1 сотрудник = 160 ч.ч. в месяц → 1 920 ч.ч. в год.",
                  "2. ИИ-агент оптимизирует 15% от общего рабочего времени — рутинные задачи (анализ резюме, подготовка к собеседованиям, проверка тестов, оформление офферов и т.д.). В таблице — реальные значения по каждому процессу, включая: время на 1 резюме (7 мин / 5 мин), количество резюме (14 505 / 256 701), оптимизацию по каждому процессу (10%, 15%, 30% — в зависимости от задачи).",
                  "3. Общее время на рутинные задачи (без ИИ в год на 50 сотрудников HR СГ): 27 284 ч.ч. Это сумма по всем 16 процессам — реальное время, которое тратится без ИИ-агента.",
                  "4. Общее количество человеко-часов с ИИ (в год на 50 сотрудников HR СГ): 16 692 ч.ч. Это сумма по всем 16 процессам — время, которое будет тратиться после внедрения ИИ-агента (с учётом оптимизации 10–80% по каждому процессу).",
                  "5. Оптимизация по каждому процессу — от 10% до 80% (в зависимости от задачи).",
                  "6. Экономия человеко-часов в год (на 50 сотрудников HR СГ): 7 712 ч.ч. → 27 284 – 16 692 = 7 712 ч.ч. (–28,3%)",
                  "7. Экономия в рублях в год (на 50 сотрудников HR СГ): 5 784 000 руб. → 7 712 ч.ч. × 750 руб./ч = 5 784 000 руб.",
