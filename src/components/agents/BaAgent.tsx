        ...
        {showDetail && (
          <div style={{ marginTop: 16, padding: "20px", background: "#f0f4ff", borderRadius: 10, border: "1px solid #c5d5f5" }}>
            ...
            <div>
              ...
              <div style={{ marginTop: 12, padding: "12px 16px", background: "#e8f5e9", borderRadius: 8, border: "1px solid #a5d6a7", fontSize: "0.87rem", color: "#1b5e20", lineHeight: 1.8 }}>
                <b>Автоматизация рабочих процессов СА по анализу БТ и написанию ТЗ в год</b> = Кол-во ч.ч./год (без ИИ) − Кол-во ч.ч./год (с ИИ) = 1 848 ч.ч./год − 1 663 ч.ч./год = <b>184,2 ч.ч./год автоматизации на рабочие процессы СА, связанные с анализом БТ и написание ТЗ</b>
              </div>
            </div>
