  ...
  return (
    <>
        ...
        {showDetail && (
          <div style={{ marginTop: 16, padding: "20px", background: "#f0f4ff", borderRadius: 10, border: "1px solid #c5d5f5" }}>
            ...
            <div style={{ marginBottom: 18, padding: "16px", background: "#fff", borderRadius: 8, border: "1px solid #dde3f5" }}>
              ...
              <div style={{ lineHeight: 2, color: "#333", fontSize: "0.93rem" }}>
                <div>• Кол-во часов на рабочие процессы по написанию БТ в день = <b>4 ч.</b></div>
                <div>• Рабочих дней в месяце = <b>22 дня</b></div>
                <div>• Среднее кол-во написанных БТ в месяц на 1 БА = <b>3 шт.</b></div>
                <div>• Время написания 1 БТ = (4 ч. × 22 дня) ÷ 3 БТ/мес. = <b>29 ч./1 БТ</b></div>
                <div>• Себестоимость 1 БТ = 29 ч.ч. * 718 ₽/ч. (себестоим. 1 раб. часа) = <b>20 822 ₽</b></div>
              </div>
            </div>
            <div style={{ marginBottom: 18, padding: "16px", background: "#fff", borderRadius: 8, border: "1px solid #dde3f5" }}>
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.82rem" }}>
                  ...
                  <tbody>
                    {[
                      [1, "Генерация вопросов к заказчику перед первой встречей", "0.267", "5.87", "70.4", "0.227", "5.00", "60.0", "15%"],
                      [2, "Подготовка к встречам (составление повестки, сбор информации)", "0.4", "8.8", "105.6", "0.34", "7.48", "89.8", "15%"],
                      [3, "Оформление встреч (написание протокола, транскрибация)", "0.4", "8.8", "105.6", "0.34", "7.48", "89.8", "15%"],
                      [4, "Поиск и рекомендация успешных практик (проектов/задач)", "0.267", "5.87", "70.4", "0.227", "5.00", "60.0", "15%"],
                      [5, "Генерация Бизнес-Требований (БТ)", "2.133", "46.93", "563.2", "1.813", "39.89", "478.7", "15%"],
                      [6, "Проверка и оценка Бизнес-Требований перед передачей в ИТ", "0.533", "11.73", "140.8", "0.453", "10.0", "120.0", "15%"],
                    ].map((row, i) => (
                    ...
                    <tr style={{ background: "#e8f0fe", fontWeight: 700 }}>
                      ...
                      {["4.0", "88.0", "1 056", "3.4", "74.8", "897.6", "15%"].map((v, i) => (
              ...
              <div style={{ marginTop: 12, padding: "12px 16px", background: "#e8f5e9", borderRadius: 8, border: "1px solid #a5d6a7", fontSize: "0.87rem", color: "#1b5e20", lineHeight: 1.8 }}>
                <b>Автоматизация рабочих процессов БА по написанию БТ в год</b> = Кол-во ч.ч./год (без ИИ) − Кол-во ч.ч./год (с ИИ) = 1 056 ч.ч./год - 897,6 ч.ч./год = <b>158 ч.ч./год автоматизация на рабочие процессы 1 Бизнес-Аналитика</b>
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.82rem" }}>
                  ...
                  <tbody>
                    {[
                      [1, "Анализ Бизнес-Требований, полученных от Бизнес-Аналитиков", "0.75", "16.5", "198", "0.675", "14.85", "178.2", "10%"],
                      [2, "Написание Технического Задания (ТЗ) на основе БТ", "1.5", "33.0", "396", "1.35", "29.7", "356.4", "10%"],
                      [3, "Сопоставление ТЗ и БТ, выявление ошибок и несоответствий", "0.75", "16.5", "198", "0.675", "14.85", "178.2", "10%"],
                      [4, "Написание пользовательской документации по проекту", "0.5", "11.0", "132", "0.45", "9.9", "118.8", "10%"],
                    ].map((row, i) => (
                      <tr key={i} style={{ background: i % 2 === 0 ? "#f5f7ff" : "#fff" }}>
                        {row.map((cell, j) => (
                          <td key={j} style={{ padding: "7px 10px", borderBottom: "1px solid #e0e6f0", color: j === 1 ? "#1a237e" : "#333", textAlign: j === 1 ? "left" : "center", fontWeight: j === 0 ? 600 : 400 }}>{cell}</td>
                    ...
                    <tr style={{ background: "#e8f0fe", fontWeight: 700 }}>
                      <td style={{ padding: "8px 10px", borderTop: "2px solid #0056b3", color: "#1a237e", textAlign: "center" }} colSpan={2}>ИТОГО</td>
                      {["3.5", "77.0", "924", "3.15", "69.3", "831.6", "10%"].map((v, i) => (
                        <td key={i} style={{ padding: "8px 10px", borderTop: "2px solid #0056b3", color: "#1b5e20", textAlign: "center", fontWeight: 700 }}>{v}</td>
                      ))}
                    </tr>
                  </tbody>
              ...
              <div style={{ marginTop: 12, padding: "12px 16px", background: "#e8f5e9", borderRadius: 8, border: "1px solid #a5d6a7", fontSize: "0.87rem", color: "#1b5e20", lineHeight: 1.8 }}>
                <b>Автоматизация рабочих процессов СА по анализу БТ и написанию ТЗ в год</b> = Кол-во ч.ч./год (без ИИ) − Кол-во ч.ч./год (с ИИ) = 924 ч.ч./год - 831,6 ч.ч./год = <b>92,4 ч.ч./год автоматизации на рабочие процессы 1 Системного Аналитика, связанные с анализом БТ и написание ТЗ</b>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                { label: "Время написания 1 БТ с AI-агентом", value: "29 ч.ч. /1 БТ (без ИИ) * (1 - 0,15 оптимизации ИИ по рабочим процессам) = 29 ч.ч./1 БТ × 0,85 =", result: "24,65 ч.ч./1 БТ (с AI-агентом)" },
                { label: "Себестоимость 1 БТ с AI-агентом", value: "24,65 ч.ч./1 БТ * 718 ₽/ч. (себестоим. 1 раб. часа) =", result: "17 698,7 ₽" },
                { label: "Автоматизация ч.ч. на 1 БТ с ИИ-агентом", value: "29 ч.ч. - 24,65 ч.ч. =", result: "на 4,35 ч.ч. быстрее пишется 1 БТ/мес" },
                { label: "Количество автоматизированного времени в год на написание БТ", value: "812 БТ/год (сейчас) × 4,35 ч.ч. автоматизации/1 БТ =", result: "3 543,2 ч.ч. сможет быть автоматизировано" },
                { label: "Потенциальное кол-во прироста написанных БТ в год", value: "3 543,2 ч.ч. ÷ 24,65/1 БТ (с ИИ) =", result: "143 БТ в год (прирост написанных БТ за год с учетом автоматизации рабочих процессов)" },
                { label: "Общая годовая оптимизация", value: "Потенциальное кол-во прирост БТ/Год * Себестоимость 1 БТ/Руб. = 143 БТ * 20 822 ₽ =", result: "2 977 546 ₽" },
              ].map((item, i) => (
      ...
      <div style={s.economyBox}>
        <span style={s.economyValue}>2 977 546 ₽</span>
        <span style={s.economyLabel}>Общая годовая оптимизация</span>
        <div style={s.econCalc}>
          <b>Эквивалентно 4 147 ч.ч. на написание БТ</b>
        </div>
      </div>
    </>
  );
      ...
      <div style={s.card}>
        ...
        {showDetail && (
          <div style={{ marginTop: 16, padding: "20px", background: "#f0f4ff", borderRadius: 10, border: "1px solid #c5d5f5" }}>
            ...
            <div style={{ marginBottom: 18 }}>
              <div style={{ fontWeight: 700, color: "#333", marginBottom: 8, fontSize: "0.95rem" }}>I. Рабочие процессы Бизнес-аналитика (Банк)</div>
              <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.82rem" }}>
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    {[
                      [1, "Генерация вопросов к заказчику перед первой встречей", "0.5", "11.0", "132", "0.425", "9.35", "112.2", "15%"],
                      [2, "Подготовка к встречам (составление повестки, сбор информации)", "0.75", "16.5", "198", "0.6375", "14.03", "168.3", "15%"],
                      [3, "Оформление встреч (написание протокола, транскрибация)", "0.75", "16.5", "198", "0.6375", "14.03", "168.3", "15%"],
                      [4, "Поиск и рекомендация успешных практик (проектов/задач)", "0.5", "11.0", "132", "0.425", "9.35", "112.2", "15%"],
                      [5, "Генерация Бизнес-Требований (БТ)", "4.0", "88.0", "1 056", "3.4", "74.8", "897.6", "15%"],
                      [6, "Проверка и оценка Бизнес-Требований перед передачей в ИТ", "1.0", "22.0", "264", "0.85", "18.7", "224.4", "15%"],
                    ].map((row, i) => (
                      <tr key={i} style={{ background: i % 2 === 0 ? "#f5f7ff" : "#fff" }}>
                        {row.map((cell, j) => (
                          <td key={j} style={{ padding: "7px 10px", borderBottom: "1px solid #e0e6f0", color: j === 1 ? "#1a237e" : "#333", textAlign: j === 1 ? "left" : "center", fontWeight: j === 0 ? 600 : 400 }}>{cell}</td>
                    ...
                    <tr style={{ background: "#e8f0fe", fontWeight: 700 }}>
                      <td style={{ padding: "8px 10px", borderTop: "2px solid #0056b3", color: "#1a237e", textAlign: "center" }} colSpan={2}>ИТОГО</td>
                      {["7.5", "165.0", "1 980", "6.375", "140.25", "1 683.0", "15%"].map((v, i) => (
                        <td key={i} style={{ padding: "8px 10px", borderTop: "2px solid #0056b3", color: "#1b5e20", textAlign: "center", fontWeight: 700 }}>{v}</td>
                      ))}
                    </tr>
                  </tbody>
              ...
              <div style={{ marginTop: 12, padding: "12px 16px", background: "#e8f5e9", borderRadius: 8, border: "1px solid #a5d6a7", fontSize: "0.87rem", color: "#1b5e20", lineHeight: 1.8 }}>
                <b>Автоматизация рабочих процессов БА по написанию БТ в год</b> = Кол-во ч.ч./год (без ИИ) − Кол-во ч.ч./год (с ИИ) = 1 980 ч.ч./год − 1 683 ч.ч./год = <b>297 ч.ч./год автоматизации на рабочие процессы 1 Бизнес-Аналитика</b>
              </div>
            </div>

            <div>
              <div style={{ fontWeight: 700, color: "#333", marginBottom: 8, fontSize: "0.95rem" }}>II. Рабочие процессы Системного аналитика (Банк)</div>
              <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.82rem" }}>
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    {[
                      [1, "Анализ Бизнес-Требований, полученных от Бизнес-Аналитиков", "1.5", "33.0", "396", "1.35", "29.7", "356.4", "10%"],
                      [2, "Написание Технического Задания (ТЗ) на основе БТ", "3.0", "66.0", "792", "2.7", "59.4", "712.8", "10%"],
                      [3, "Сопоставление ТЗ и БТ, выявление ошибок и несоответствий", "1.5", "33.0", "396", "1.35", "29.7", "356.4", "10%"],
                      [4, "Написание пользовательской документации по проекту", "1.0", "22.0", "264", "0.9", "19.8", "237.6", "10%"],
                    ].map((row, i) => (
                      <tr key={i} style={{ background: i % 2 === 0 ? "#f5f7ff" : "#fff" }}>
                        {row.map((cell, j) => (
                          <td key={j} style={{ padding: "7px 10px", borderBottom: "1px solid #e0e6f0", color: j === 1 ? "#1a237e" : "#333", textAlign: j === 1 ? "left" : "center", fontWeight: j === 0 ? 600 : 400 }}>{cell}</td>
                    ...
                    <tr style={{ background: "#e8f0fe", fontWeight: 700 }}>
                      <td style={{ padding: "8px 10px", borderTop: "2px solid #0056b3", color: "#1a237e", textAlign: "center" }} colSpan={2}>ИТОГО</td>
                      {["7.0", "154.0", "1 848", "6.3", "138.6", "1 663.2", "10%"].map((v, i) => (
                        <td key={i} style={{ padding: "8px 10px", borderTop: "2px solid #0056b3", color: "#1b5e20", textAlign: "center", fontWeight: 700 }}>{v}</td>
                      ))}
                    </tr>
                  </tbody>
              ...
              <div style={{ marginTop: 12, padding: "12px 16px", background: "#e8f5e9", borderRadius: 8, border: "1px solid #a5d6a7", fontSize: "0.87rem", color: "#1b5e20", lineHeight: 1.8 }}>
                <b>Автоматизация рабочих процессов СА по анализу БТ и написанию ТЗ в год</b> = Кол-во ч.ч./год (без ИИ) − Кол-во ч.ч./год (с ИИ) = 1 848 ч.ч./год − 1 663 ч.ч./год = <b>184,2 ч.ч./год автоматизации на рабочие процессы 1 СА, связанные с анализом БТ и написание ТЗ</b>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                { label: "Время написания 1 БТ с AI-агентом", value: "52 ч.ч. /1 БТ (без ИИ) * (1 - 0,15 оптимизации ИИ по рабочим процессам) = 52 ч.ч./1 БТ × 0,85 =", result: "44,2 ч.ч./1 БТ (с AI-агентом)" },
                { label: "Себестоимость 1 БТ с AI-агентом", value: "44,2 ч.ч./1 БТ * 718 ₽/ч. (себестоим. 1 раб. часа) =", result: "31 735,6 ₽" },
