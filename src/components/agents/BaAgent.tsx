  ...
  return (
    <>
          ...
          <div style={{ marginTop: 16, padding: "20px", background: "#f0f4ff", borderRadius: 10, border: "1px solid #c5d5f5" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                ...
                { label: "Общая годовая оптимизация", value: "Потенциальное кол-во прирост БТ/Год * Себестоимость 1 БТ/Руб. с AI-агентом = 143 БТ * 17 698,7 ₽ =", result: "2 530 914 ₽" },
              ].map((item, i) => (
      ...
      <div style={s.economyBox}>
        <span style={s.economyValue}>2 530 914 ₽</span>
        <span style={s.economyLabel}>Общая годовая оптимизация</span>
        <div style={s.econCalc}>
          <b>Эквивалентно 3 543 ч.ч. на написание БТ</b>
        </div>
      </div>
    </>
  );
